  ...
  return (
    <>
      ...
      >
        ...
        <div className="relative z-20 flex min-h-0 w-full min-w-0 flex-col pt-24 sm:pt-28 lg:pt-32">
          <div className="px-5 pt-6 sm:px-6 lg:px-10">
          ...
          <div className="flex min-h-0 flex-1 flex-col px-5 pb-6 sm:px-6 lg:px-10">
            <div className="mt-auto flex w-full max-w-md flex-col space-y-12 self-center pt-6 sm:pt-8 lg:max-w-2xl lg:space-y-20">
              ...
              <div className="flex flex-col gap-3 items-center lg:flex-row lg:justify-center lg:gap-5 pb-6 lg:pb-10">
                <Link
                  href="/products"
